...
class StoreMachineRequest extends FormRequest
{
    ...
    {
        if (! $this->filled('machine_name') && $this->filled('machine_code')) {
            $this->merge(['machine_name' => $this->input('machine_code')]);
        }
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // nullable — partial CSV imports may omit the name; admin fills it in via Edit later
